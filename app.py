...
# UPLOADER IS PROPERLY DECLARED HERE
...
def analyze_mispunches(row, punch_cols, mode):
    ...
    return pd.Series([total_punches, shift_val, working_hours_str, status, category, issue_type])
...
if attendance_file is not None:
    ...
    # RE-ORDER COLUMNS: Shift placed cleanly, Issue Type pushed to extreme right end
